...
--
-- Host: localhost    Database: locrentempty
-- ------------------------------------------------------
...
CREATE TABLE `reservation` (
  ...
  `expected_date_return` datetime NOT NULL,
...
CREATE TABLE `state` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `IX_state_initials` (`initials`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vehicle` (
  ...
  `manufacturer_year` int NOT NULL,
...
INSERT INTO `versioninfo` VALUES (1,'2022-05-04 22:15:01','Migration001');
...
-- Dump completed on 2022-05-09  7:55:06
